...
export default function Accreditations() {
  ...
  {accreditations.map((item, index) => (
    <div
      key={item.title}
      className={`group relative bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 ease-out flex flex-col items-center justify-center cursor-pointer overflow-hidden ${
        isVisible
